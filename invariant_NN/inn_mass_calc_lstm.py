...
if True:
    ...
    # model.load_weights('saved_models/inn_mass_calc_lstm/inn_mass_calc_lstm_last')

model.summary()

# model.load_weights('saved_models/inn_mass_calc_lstm/inn_mass_calc_lstm')
# sys.exit()

log_filename = "saved_models/inn_mass_calc_lstm/inn_mass_calc_lstm.log"
...
chk_filename = "saved_models/inn_mass_calc_lstm/inn_mass_calc_lstm"
...
chk2_filename = "saved_models/inn_mass_calc_lstm/inn_mass_calc_lstm_last"
...
history = model.fit(
    ...
    generator(X_train, Y_train, n_train, n_rand_rot, ix_train),
    # validation_data=generator(X_valid, Y_valid, n_valid, batch_size, ix_valid),
    validation_data=generator(X_valid, Y_valid, n_valid, n_rand_rot, ix_valid),
