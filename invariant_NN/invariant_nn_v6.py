...
model.load_weights('saved_models/inv_nn_v6')
sys.exit()

log_filename = "saved_models/inv_nn_v6.log"
...
chk_filename = "saved_models/inv_nn_v6"
...
# model_test.load_weights('saved_models/inv_nn_v6')
